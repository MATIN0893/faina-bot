...
async def start_cmd(message: types.Message):
    welcome_text = (
        "Приветствую! Я **Помощница Фаина** — ваш персональный школьный секретарь.\n\n"
        "Отправьте текст или фото документа — я приготовлю всё в **Word** или **Excel** "
        "с правильным таджикским алфавитом (Ғ, Ӣ, Қ, Ӯ, Ҳ, Ҷ)!"
    )
